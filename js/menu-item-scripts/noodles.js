...
function updateMenu(numberOfMenuItems) {
  ...
  for (let i = 1; i <= numberOfMenuItems; i++) {
    ...
    const priceSmall = `$${getRandomPrice(12, 18)}`;
    const priceLarge = `$${getRandomPrice(15, 21)}`;
        ...
        <div class="row">
          <div class="col-sm-5">
            <div class="menu-item-photo">
              ...
              <img class="img-responsive" width="250" height="150" src="/images/menu-item-tiles/noodles/noodles (${i}).jpg" alt="Item" />
            </div>
