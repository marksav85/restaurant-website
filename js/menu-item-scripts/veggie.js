...
const numberOfMenuItems = 11;

// Category menu name
const categoryMenuName = "VE";
        ...
        <div class="row">
          <div class="col-sm-5">
            <div class="menu-item-photo">
              ...
              <img class="img-responsive" width="250" height="150" src="../../images/menu-item-tiles/veggie/veggie (${i}).jpg" alt="Item" />
            </div>
