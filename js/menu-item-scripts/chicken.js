...
const numberOfMenuItems = 20;

// Category menu name
const categoryMenuName = "CH";
        ...
        <div class="row">
          <div class="col-sm-5">
            <div class="menu-item-photo">
              ...
              <img class="img-responsive" width="250" height="150" src="../../images/menu-item-tiles/chicken/chicken (${i}).jpg" alt="Item" />
            </div>
