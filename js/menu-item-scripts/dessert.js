...
const numberOfMenuItems = 2;

// Category menu name
const categoryMenuName = "DE";
...
function updateMenu(numberOfMenuItems) {
  ...
  for (let i = 1; i <= numberOfMenuItems; i++) {
    ...
    const basePrice = getRandomPrice(12, 18);
        ...
        <div class="row">
          <div class="col-sm-5">
            <div class="menu-item-photo">
              ...
              <img class="img-responsive" width="250" height="150" src="../../images/menu-item-tiles/dessert/dessert (${i}).jpg" alt="Item" />
            </div>
